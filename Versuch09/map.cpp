...
{
    if(vectorCities.contains(street->getCity1()) && vectorCities.contains(street->getCity2()))
    {
...
double Map::get_length(const Street* street) const
{
    ...
    double cathetus1 = street->getCity1()->get_xCoord() - street->getCity2()->get_xCoord();
    double cathetus2 = street->getCity1()->get_yCoord() - street->getCity2()->get_yCoord();
